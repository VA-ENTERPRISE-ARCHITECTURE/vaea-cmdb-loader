...
public final class PrintUtils {
	...
	public static void printBusService(BusinessService bservice) {
		if (bservice != null) {
			...
			System.out.println("Alt CI ID: " + bservice.getAltCIID());
			System.out.println("Status: " + bservice.getStatus());
			System.out.println("Business Unit: " + bservice.getBusinessUnit());
			System.out.println("Responsible Organization: " + bservice.getResponsibleOrganization());
			/*
			...
			System.out.println("Accreditaion Boundary: " + bservice.getAccreditationBoundary());
			System.out.println("Description: " + bservice.getDescription());
			*/
			System.out.println("");
		}
	}
