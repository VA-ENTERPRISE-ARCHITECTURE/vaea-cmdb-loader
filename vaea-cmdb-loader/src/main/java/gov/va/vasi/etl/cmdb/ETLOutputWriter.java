...
public class ETLOutputWriter {
	...
	public void writeOutput() throws IOException {
		...
		header.createCell(0).setCellValue("CM use only");
		header.createCell(1).setCellValue("CMDB Object Id");
		header.createCell(2).setCellValue("Name");
		header.createCell(3).setCellValue("Alt CI ID");
		header.createCell(4).setCellValue("Serial Number");
		header.createCell(5).setCellValue("System Name");
		header.createCell(6).setCellValue("Notes/Description");
		header.createCell(7).setCellValue("Status");
		header.createCell(8).setCellValue("DNS Name");
		...
		while (outIterator.hasNext()) {
			...
			row.createCell(1).setCellValue(outRecord.getCmdbID());
			row.createCell(2).setCellValue(outRecord.getName());
			row.createCell(3).setCellValue(outRecord.getAltCIID());
			row.createCell(4).setCellValue(outRecord.getSystemID().intValue());
			// row.createCell(5).setCellValue("System Name");
			row.createCell(6).setCellValue(outRecord.getDescription());
			row.createCell(7).setCellValue(outRecord.getStatus());
			// row.createCell(8).setCellValue("DNS Name");
